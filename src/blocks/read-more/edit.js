...
function edit( props ) {
	...
	const {	linkTarget,	placeholder, rel, url, buttonText, bootClass, bootSizesClass, bootAlign, bgColor, txtColor, borderColor, bSize } = attributes;
		...
		<>
			...
			<div {...blockProps}>
				<RichText
					...
					style={{backgroundColor: bgColor, color: txtColor, borderBottom: borderColor + ' solid ' + bSize + 'px'}}
					value={ buttonText }
